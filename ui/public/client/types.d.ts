...
export type WriteRequest = {
    ...
    type: "CreateStackEditBranch";
    params: CreateStackEditBranch;
} | {
    type: "MergeStackEditBranch";
    params: MergeStackEditBranch;
} | {
    type: "DiscardStackEditBranch";
    params: DiscardStackEditBranch;
} | {
