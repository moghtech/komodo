...
<RemoteCodeFile
	title="https://github.com/moghtech/komodo/blob/1.17.0/compose/periphery.compose.yaml"
	url="https://raw.githubusercontent.com/moghtech/komodo/1.17.0/compose/periphery.compose.yaml"
	language="yaml"
/>
```
