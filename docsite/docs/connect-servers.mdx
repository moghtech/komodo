...
You can install Periphery as a systemd managed process, run it as a [docker container](https://github.com/moghtech/komodo/blob/main/compose/periphery.compose.yaml), or do whatever you want with the binary.
