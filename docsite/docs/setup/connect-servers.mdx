...
Every server you want to manage with Komodo needs the **Periphery** agent installed. Periphery is a small, stateless binary that receives commands from Komodo Core.
