...
It avoid a number of complications which can come up when running Periphery in a container.
...
:::warning
**User installs**: To ensure periphery stays running when your user logs out, make sure to enable linger:
```bash
