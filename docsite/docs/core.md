...
That includes registration policy. Core can disable registration globally, or split that control by
login path so local username/password signup and OIDC signup are governed separately.
