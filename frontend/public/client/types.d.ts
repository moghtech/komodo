...
export type JwtOrTwoFactor = {
    ...
    type: "Passkey";
    data: _RequestChallengeResponse;
} | {
    type: "Totp";
    data: {};
};
...
export type AuthRequest = {
    ...
    type: "CompleteTotpLogin";
    params: CompleteTotpLogin;
} | {
    type: "CompletePasskeyLogin";
...
export type UserRequest = {
    ...
    type: "BeginTotpEnrollment";
    params: BeginTotpEnrollment;
} | {
    type: "ConfirmTotpEnrollment";
    params: ConfirmTotpEnrollment;
} | {
    type: "UnenrollTotp";
    params: UnenrollTotp;
} | {
    type: "BeginPasskeyEnrollment";
    params: BeginPasskeyEnrollment;
} | {
    type: "ConfirmPasskeyEnrollment";
    params: ConfirmPasskeyEnrollment;
} | {
    ...
    type: "UpdateThirdPartySkip2fa";
    params: UpdateThirdPartySkip2fa;
};
